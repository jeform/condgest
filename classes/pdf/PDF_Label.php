...
class PDF_Label extends satecmax_pdf  {
...
//		'6182'=>array('name'=>'6182',	'paper-size'=>'letter', 'metric'=>'mm',	'marginLeft'=>5,		'marginTop'=>21, 		'NX'=>2,	'NY'=>7,	'SpaceX'=>5,		'SpaceY'=>0,	'width'=>102,		'height'=>34,		'font-size'=>9),
		'6180'=>array('name'=>'6180',	'paper-size'=>'letter', 'metric'=>'mm',	'marginLeft'=>4.8,		'marginTop'=>12.7, 		'NX'=>3,	'NY'=>10,	'SpaceX'=>3.1,		'SpaceY'=>0,	'width'=>66.7,		'height'=>25.4,		'font-size'=>9),
		'6182'=>array('name'=>'6182',	'paper-size'=>'letter', 'metric'=>'mm',	'marginLeft'=>4.0,		'marginTop'=>21.2, 		'NX'=>2,	'NY'=>7,	'SpaceX'=>5.2,		'SpaceY'=>0,	'width'=>101.6,		'height'=>33.9,		'font-size'=>11),
		'convocacaoDiaconos'=>array('name'=>'convocacaoDiaconos','paper-size'=>'A4', 'metric'=>'cm',	'marginLeft'=>4.6,		'marginTop'=>18, 		'NX'=>1,	'NY'=>1,	'SpaceX'=>0,		'SpaceY'=>0,	'width'=>11.9,		'height'=>3.8,		'font-size'=>14),
	);
	...
	function Add_PDF_Label($texte) {
		...
		if ($this->_COUNTX == $this->_X_Number and $this->_COUNTY == ($this->_Y_Number-1)) 
			{
			// Fim da Pagina, zerar variaveis para iniciar outra pagina...
			$this->_COUNTX=0;
			$this->_COUNTY=0;
			}
		elseif ($this->_COUNTX == $this->_X_Number and $this->_COUNTY < $this->_Y_Number)
			{
			$this->_COUNTX=0;
			$this->_COUNTY++;
			}
