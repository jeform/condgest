<?php
class caixa_movimento_saida extends satecmax_mask
	{
	...
	function __construct()
		...
		$this->setTitle(__("Movimento de Saida Caixa"));
	...
	function setFieldsProperties()
		...
		$this->build("p4a_db_source","srcCategorias")
			...
			->setPk("cd_categoria")
			->setWhere("tp_categoria = 2 and st_categoria = 1")
			->Load();
	...
	function gerarMovimento()
		...
		try
			...
			$objMovimento->newMovimentoSaida(
