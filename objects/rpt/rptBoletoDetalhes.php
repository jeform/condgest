<?php
class rptBoletoDetalhes extends satecmax_pdf
	{
	...
	function setParametros($cdBoletoMes)
		...
		foreach($arrDadosHeader as $linha => $dadosLinhaHeader )
			{
			$this->cell(190,5,utf8_decode("COMPOSIÇÃO DOS ÍTENS DE COBRANÇA REFERENTE À ".$dadosLinhaHeader["mes_ano_referencia"]),1,1,"C");
			$this->ln();
			$this->ln();
			}
					    ...
					    (select 
					     ...
					     (select 
					        ...
					        where
					            b.cd_unidade = a.cd_unidade
					                and b.cd_boleto_mes_unidade = a.cd_boleto_mes_unidade
					                and b.cd_item_cobranca = 3) as vlr_outros,           
					    (select 
		...
		$this->cell(12,5,utf8_decode("ÁREA"),1,0,"C");
		$this->cell(20,5,utf8_decode("VENCIMENTO"),1,0,"C");
		$this->cell(28,5,utf8_decode("TX. CONDOMINIAL"),1,0,"C");
		$this->cell(25,5,utf8_decode("BENFEITORIA"),1,0,"C");
		$this->cell(25,5,utf8_decode("RATEIO"),1,0,"C");
		$this->cell(25,5,utf8_decode("ÁGUA COMUM"),1,0,"C");
		$this->cell(25,5,utf8_decode("OUTROS"),1,0,"C");
	...
	function imprimirLinhaDetalhes($dadosLinha)
		...
		$this->cell(12,5,utf8_decode($dadosLinha["unidade"]),"BT",0,"C");
		$this->cell(20,5,utf8_decode($dadosLinha["dt_vencimento"]),"BT",0,"C");		
		$this->cell(28,5,utf8_decode("R$ ".number_format($dadosLinha["vlr_condominio"],2,",",".")),"BT",0,"C");
		$this->cell(25,5,utf8_decode("R$ ".number_format($dadosLinha["vlr_benfeitoria"],2,",",".")),"BT",0,"C");
		$this->cell(25,5,utf8_decode("R$ ".number_format($dadosLinha["vlr_rateio"],2,",",".")),"BT",0,"C");
		$this->cell(25,5,utf8_decode("R$ ".number_format($dadosLinha["vlr_rat_agua"],2,",",".")),"BT",0,"C");
		$this->cell(25,5,utf8_decode("R$ ".number_format($dadosLinha["vlr_outros"],2,",",".")),"BT",0,"C");
		...
		$this->vlr_outros += $dadosLinha["vlr_outros"];
	...
	function imprimeTotalCategoria()
		{
		$this->setFont("tahoma","",8);
		$this->cell(55,5,"R$ ".number_format($this->vlr_condominio,2,",","."),"BT",0,"R");
		$this->cell(26,5,"R$ ".number_format($this->vlr_benfeitoria,2,",","."),"BT",0,"R");
		$this->cell(26,5,"R$ ".number_format($this->vlr_rateio,2,",","."),"BT",0,"R");
		$this->cell(22,5,"R$ ".number_format($this->vlr_rat_agua,2,",","."),"BT",0,"R");
		$this->cell(24,5,"R$ ".number_format($this->vlr_outros,2,",","."),"BT",0,"R");
		$this->cell(37,5,"R$ ".number_format($this->vlr_total,2,",","."),"BT",0,"C");
	...
	function Output()
		{
		return parent::Output("rptComposicaoBoletos.pdf","S");
		}
