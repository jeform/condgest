...
<li>Caso tenha problemas ao imprimir, copie a seqüência numérica abaixo e pague no caixa eletrônico ou no internet banking:<br><br>
<span class="ld2">
...
<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
  <tr> 
    ...
    Condomínio: <?php echo $dadosboleto["identificacao"];?>
    <br>CNPJ: <?php echo isset($dadosboleto["cpf_cnpj"]) ?"".$dadosboleto["cpf_cnpj"] : '' ?><br>
	Endereço: <?php echo $dadosboleto["endereco"]; ?><br>
	Cidade/Estado: <?php echo $dadosboleto["cidade_uf"]; ?><br>
    </td>
...
Desconto</td><td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.png width=1 border=0></td><td class=ct valign=top width=112 height=13>(-) 
...
do Cedente</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top width=472 height=12> 
  <span class="campo">
...
Proces.</td><td class=ct valign=top width=7 height=13> <img height=13 src=imagens/1.png width=1 border=0></td><td class=ct valign=top width=180 height=13>Nosso 
...
Valor Doc.</td><td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.png width=1 border=0></td><td class=ct valign=top width=180 height=13>(=) 
